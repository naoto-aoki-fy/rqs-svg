...
const char *gengetopt_args_info_purpose = "Run the OpenMP CPU quantum circuit simulator.";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --threads=INT      Number of OpenMP threads (0 uses the runtime default)\n                           (default=`0')",
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:q:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* Number of OpenMP threads (0 uses the runtime default).  */
