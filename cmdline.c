...
const char *gengetopt_args_info_purpose = "Run the multi-GPU quantum circuit simulator.";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->gpus_arg = gengetopt_strdup ("0,1,2,3,4,5,6,7");
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->gpus_given)
    {
      fprintf (stderr, "%s: '--gpus' ('-g') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'g':	/* Comma-separated GPU IDs.  */
        
        
          if (update_arg( (void *)&(args_info->gpus_arg), 
               &(args_info->gpus_orig), &(args_info->gpus_given),
              &(local_args_info.gpus_given), optarg, 0, "0,1,2,3,4,5,6,7", ARG_STRING,
