/*
  ...
  gengetopt --input=args.ggo --file-name=cmdline --output-dir=.
...
const char *gengetopt_args_info_purpose = "Run the OpenMP quantum circuit simulator benchmark.";

const char *gengetopt_args_info_usage = "Usage: qcs [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --threads=INT      OpenMP threads (0 uses the runtime default)\n                           (default=`0')",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->num_qubits_help = gengetopt_args_info_help[2] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->num_qubits_given)
    {
      fprintf (stderr, "%s: '--num-qubits' ('-q') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVq:s:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'q':	/* Number of qubits.  */


          if (update_arg( (void *)&(args_info->num_qubits_arg),
               &(args_info->num_qubits_orig), &(args_info->num_qubits_given),
              &(local_args_info.num_qubits_given), optarg, 0, "24", ARG_INT,
        ...
        case 's':	/* Number of benchmark samples.  */
          ...
          break;
        case 't':	/* OpenMP threads (0 uses the runtime default).  */
