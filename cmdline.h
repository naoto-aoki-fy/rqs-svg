...
struct gengetopt_args_info
{
  ...
  int threads_arg;	/**< @brief Number of OpenMP threads (0 uses the runtime default) (default='0').  */
  char * threads_orig;	/**< @brief Number of OpenMP threads (0 uses the runtime default) original value given at command line.  */
  const char *threads_help; /**< @brief Number of OpenMP threads (0 uses the runtime default) help description.  */
